        ...
        <table class="table table-striped table bordered">
            ...
            <tbody>
                ...
                $statement = $db->query('SELECT items.id, items.name, items.description, items.price, categories.name AS category
                                        ...
                                        ORDER BY items.id DESC'); // Mettre de l'ordre du plus récent au plus vieux
                while ($item = $statement->fetch()) {
                    ...
                    echo ' ';
                    echo '<a class="btn btn-primary" href="update.php?id=' . $item['id'] . '"><span class="glyphicon glyphicon-pencil"></span> Modfier</a>';
                    echo ' ';
